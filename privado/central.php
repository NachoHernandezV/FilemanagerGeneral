...
<table width="100%" border="0px" align="center">
	...
	<?php
		...
		{	
			...
			//CREAR SUBCARPETAS
				$consultaarchivos="SELECT a.idcarpeta,a.carpeta,a.carpetaMadre FROM carpetas a WHERE a.carpetaMadre='".$_POST['madrecarp']."' and a.departamento='".$_SESSION['Areas']."'";
	...
	echo "</tr>";
		...
		if( $_POST['codigoarchivocar']>0 or $_POST['Actualizar']=='Actualizar')
		{
			...
			//obtener el area juna
				...
				//////////////////
				//echo "nombrejunto".$nombrearchivoreal2;
				...
				$consultaarchivos="SELECT a.idarchivo,a.nombrearchivo,a.nombrereal,a.fecha FROM permisos p, archivos a WHERE a.idarchivo=p.idarchivo and a.departamento='".$_SESSION['Areas']."' and p.".$nombrearchivoreal2."='si' and a.idcarpeta='".$_POST[codigoarchivocar]."'";
				$re=mysqli_query($con,$consultaarchivos);
					...
					echo "<tr>";
						...
						echo "</td>";
							...
							if($extarchivo2 == "pdf" or $extarchivo2 == "jpg" or $extarchivo2 == "png" or $extarchivo2 == "bmp" or $extarchivo2 == "html" or $extarchivo2 == "htm")
							{
								...
								//echo "</td>";
								//echo "<td align='center'>";
									echo  "<input type='hidden' name='nombre2' value='".$nombrearchivoreal2."' />";
								//echo "</td>";
								//echo "<td align='center'>";
